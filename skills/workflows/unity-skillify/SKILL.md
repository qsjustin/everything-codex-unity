...
Read `.codex-unity/state/learnings.jsonl` (or `.codex-unity/state/learnings.jsonl` as fallback for pre-v1.3.0 projects).
...
Read all existing skills in `skills/` to avoid generating a duplicate. If a skill already covers this topic, report it and suggest updating the existing skill instead.
...
2. Create directory `skills/[category]/[name]/`
3. Write SKILL.md there
4. Report: "Skill installed at skills/[category]/[name]/SKILL.md"
