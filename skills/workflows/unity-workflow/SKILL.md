...
1. **Scan the project** — use `unity-scout` (haiku) for fast codebase exploration: read AGENTS.md, find relevant existing scripts, map assembly structure
...
2. **Write C# code** following all rules in `.codex-legacy/rules/`
